    ...
    return PageFramework(
      ...
      listWidgets: [
        ...
        SettingsContainerSwitch(
          ...
          description:
              "When a notification is dismissed and the app is open, attempt to add a transaction given its information. Create a template so Ledger understands the format of a notification.",
